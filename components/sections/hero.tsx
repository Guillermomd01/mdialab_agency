  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 w-[500px] h-[500px] rounded-full bg-secondary/5 blur-3xl" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <span className="text-primary">implementada por expertos</span>{" "}
          ...
          >
            <a
              ...
              className={cn(
                ...
                "rounded-full px-8 gap-2 inline-flex"
              )}
            >
